...
class GFLHeadv2_uniH(AnchorHead):
    ...
    def __init__(self,
        ...
        super(GFLHeadv2_uniH, self).__init__(
            num_classes,
            in_channels,
    ...
    def _init_layers(self):
        ...
        self.Csw_block3 = DAT(self.feat_channels, 16, 1)
    ...
    def init_weights(self):
        ...
        bias_cls = bias_init_with_prob(0.01)
        torch.nn.init.constant_(self.gfl_cls.bias, bias_cls)
    ...
    def forward_single(self, x, scale):
        ...
        decouple_x = self.Csw_block3(decouple_x)
        ...
        bbox_pred = scale(self.gfl_reg(reg_feat_)).float()
        ...
        cls_score = self.gfl_cls(cls_feat_).sigmoid() * quality_score
