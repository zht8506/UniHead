...
if __name__=="__main__":
    ...
    m=DAttentionBaseline(q_size=(56,56),kv_size=(56,56),n_heads=4,n_head_channels=16,
                         n_groups=4,attn_drop=0.0,proj_drop=0.0,stride=1,offset_range_factor=2,
                         use_pe=True,dwc_pe=False,no_off=False,fixed_pe=False,stage_idx=3)
